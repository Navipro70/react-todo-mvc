...
function App() {
    ...
    return (
        <Container maxWidth="xs">
            <Header/>
            <Buttons importantBut={activeBut} completedBut={completedBut}
                onCompletedChanger={onCompletedChanger} onActiveChanger={onActiveChanger} onAllChanger={onAllChanger} />
            <Statistic activeCount={activeCount} finishedCount={finishedCount}/>
            <CustomInput addTask={addTask}/>
            <TodoListItems todoArray={todoState} onImportantHandler={onImportantHandler}
                           onDelete={onDelete} onCompletedHandler={onCompletedHandler}
                           activeBut={activeBut} completedBut={completedBut}
            />
        </Container>
    );
}
